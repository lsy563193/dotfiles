...
struct MD5Sum< ::obstacle_detector::Obstacles_<ContainerAllocator> >
{
  ...
  {
    return "a7b6c753a241f444aa932d3d913bcc52";
  }

  static const char* value(const ::obstacle_detector::Obstacles_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa7b6c753a241f444ULL;
  static const uint64_t static_value2 = 0xaa932d3d913bcc52ULL;
};

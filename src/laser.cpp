...
uint8_t Laser::isRobotSlip()
{
	...
	if(g_robot_slip_enable && seq != laserScanData_2_.header.seq && isScan2Ready() && ( absolute(robot::instance()->getLeftWheelSpeed()) >= 0.03 || absolute(robot::instance()->getRightWheelSpeed()) >= 0.03 ) )
	{

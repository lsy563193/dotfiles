...
Point32_t MovementBase::s_target_p = {0,0};
Point32_t MovementBase::s_origin_p = {0,0};
int16_t MovementBase::s_target_angle = 0;
float MovementBase::s_pos_x = 0;
float MovementBase::s_pos_y = 0;
//
//
//bool MovementBase::isExit()
//{
...
//	return false;
//}
//bool MovementBase::isReach()
//{
//	return false;
//}

void MovementBase::doSomething() {
	CostMap::update_position();
